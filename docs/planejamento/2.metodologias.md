...
&emsp;&emsp;O KanBan permite que seja criadas colunas que sejam organizadas conforme a necessidade de cada equipe. Nós, como equipe, estamos utilizando o ZenHub para gerenciar as issues, e nele, temos as colunas de "Product Backlog", "Icebox", "Sprint Backlog", "In Progress", "Review" e "Done", onde temos, respectivamente, as issues que ainda não foram planejadas, as issues que não serão feitas nesse semestre, as issues que serão feitas na sprint atual, as issues que estão sendo feitas, as issues que estão sendo revisadas e as issues que já foram feitas. Essa prática facilita o rastreamento do andamento das issues, o que ainda precisa ser feito no momento como prioridade, e o que não tem tanta urgência assim.
...
| 06/12/2022 | 4.0 | Atualização sobre como está sendo usado o KanBan | Iago | Luíza |
